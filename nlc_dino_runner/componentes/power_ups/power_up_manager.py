...
from nlc_dino_runner.componentes.power_ups.hammer import Hammer
from nlc_dino_runner.componentes.power_ups.shield import Shield
from nlc_dino_runner.utils.constants import DEFAULT_TYPE, SHIELD_TYPE, HAMMER_TYPE, SOUND_SHIELD, SOUND_HAMMER
